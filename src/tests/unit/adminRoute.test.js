...
describe("Admin Route Tests", () => {
  ...
  it("should return 400 error if start date is missing for best client", async () => {
    const res = await request(app)
  ...
  it("should return 400 error if end date is missing for best client", async () => {
    const res = await request(app)
  ...
  it("should return empty high paying client data with valid date params", async () => {
    const mockResponse = [];
  ...
  it("should return high paying client with valid date params", async () => {
    const mockResponse = [
      {
        id: 1,
