...
describe("Contract Route Tests", () => {
  ...
  it("authenticates a client/contractor with valid contract ID and profile ID", async () => {
    const mockResponse = {
      id: 1,
      terms: "bla bla bla",
      status: "terminated",
  ...
  it("denies access for unauthorized client/contractor with valid contract ID and profile ID", async () => {
  ...
  it("fetches contracts successfully with a valid profile ID", async () => {
    const mockResponse = [
      {
        id: 5,
        terms: "bla bla bla",
